      ...
      images: [
        {
          title: 'title',
          path: '/thumb1.jpg',
          url: 'https://github.com/ArunaJ7/MAD-Project',
        },
        {
          title: 'title',
          path: '/thumb2.jpg',
          url: 'https://github.com/thilinahansana/ITP-Project',
        },
        {
          title: 'title',
          path: '/thumb3.jpg',
          url: 'https://github.com/ArunaJ7/Movie-TV-series-browsing-system',
        },
        {
          title: 'title',
          path: '/thumb4.jpg',
          url: 'https://github.com/ArunaJ7/Online-voting-system-for-reality-show',
        },
      ],
    },
    // {
          ...
          <SwiperSlide key={index}>
            <div className='grid grid-cols-2 grid-rows-2 gap-4 cursor-pointer'>
              {slide.images.map((image, index)=> {
                return (
                  <Link href={image.url || '#'} key={index} target={image.url ? '_blank' : '_self'} rel={image.url ? 'noopener noreferrer' : ''}>
                    <div 
